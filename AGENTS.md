...
## Step4 joint (t,f) gesture selection

- Onset candidates are still generated by ArticulationCore.
- Selection is `argmax_t max_f pred_c_statepm1(t,f)`.
- Frequency candidates prefer neighbors × `HARMONIC_RATIOS` (Step1).
