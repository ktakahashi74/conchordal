...
This directory contains the v0.4 harmony-first entry path plus research
comparison scripts. Start with the curated path unless you are testing a
specific mechanism.

## Curated v0.4 Alpha Path
...
- whether `consonance_ecology.rhai` is strong enough to remain the flagship
- whether `pulse_foundation.rhai` supports rhythm foundation without implying
  complete rhythm/harmony fusion
