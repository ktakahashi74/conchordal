...
impl Individual {
    ...
    pub fn tick_articulation_lifecycle(
        ...
        self.last_consonance_level01 = consonance;
        let mut signal = self
            .articulation
    ...
    pub fn last_consonance_level01(&self) -> f32 {
        self.last_consonance_level01
    }
