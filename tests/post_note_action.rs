...
#[test]
fn post_note_applies_to_world_model() {
    ...
    assert_eq!(view.notes[0].onset_tick, timebase.sec_to_tick(1.0));
    assert_eq!(view.notes[0].dur_tick, timebase.sec_to_tick(0.5));
}
