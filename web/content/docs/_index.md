...
- A listener-side model (`ListenerTwin`) that observes only the presented sound, with optional weak DCC coupling.
- A tiered Rhai scripting surface (Core / Experimental / Tuning / Research) with a generated, drift-proof API reference.

See the [Technical Notes](/technote/) for the underlying model.
