...
Conchordalの基盤となる「ランドスケープ」は、人間の聴覚認知特性を模したポテンシャル場である。従来の作曲が格子状の音階や固定された音符に音を当てはめるのに対し、Conchordalは人間の聴覚生理そのものを仮想環境として再現する。現在は実音から周波数方向の地形を計算し、短時間の音響履歴と拍の推定を時間的な振る舞いに用いている。時間方向にも、音の輪郭から楽曲全体までの関係を保持し、生成へ返す地形を構築することを目指す。
...
長い時間構造には、順序の記憶、変形した関係の想起、まとまりの境界と終止を扱う仕組みが必要になる。全てを遅い振動子へ置き換えるのではなく、それぞれの神経認知的な基盤を整理し、聴取者の判断と照合しながら表現を選ぶ。拍への同時発音、異なる位置での応答、拍を参照しない流れを区別し、その違いが音楽として聞こえるところまでを目標に据える。
...
個体の局所的行動から、和声、旋律、リズムといった音楽的構造をボトムアップに生み出すことが、この生態系の目標である。現在の音高の適応と短時間の発音判断を足場に、持続する受け渡し、フレーズや楽曲全体の関係へと広げていく。作曲者が音符を配置するのではなく、音響生態系の力学が音楽を生み出すのである。
...
この演出のための道具が時間軸に沿って生態系の環境条件を変化させる指示書である「シナリオ」である。創作者は個々の音を指定するのではなく、系全体の状態遷移を記述する。ランドスケープの地形を変形させ、個体群の生成と消滅を制御し、発声の周期、音長、同期の設定を時間に沿って変える。これらの操作を通じて、創作者は混沌から秩序へ、あるいは静寂から飽和へといった巨視的な軌道を描くことができる。将来は、知覚されたフレーズや長い文脈が局所生成へ及ぼす作用も、作者の演出と共存させる。
